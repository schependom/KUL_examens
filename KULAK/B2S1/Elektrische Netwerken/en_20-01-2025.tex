...
\begin{document}
	...
	\begin{figure}[h!]
		...
		\begin{tikzpicture}
			...
			\draw[-latex] (-5,0)--(5,0) node[right]{Re};
			\draw[-latex] (0,-5)--(0,5) node[above]{Im};
			\draw[ultra thick, -latex] (0,0)--(1,1) node[midway,above] () {$I$};
			\draw[ultra thick, -latex] (0,0)--(2,0) node[midway,below] () {$E_0$};
		\end{tikzpicture}
	\end{figure}
